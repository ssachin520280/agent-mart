    ...
    <PageShell>
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-14">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[2.5rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.075),rgba(255,255,255,0.025))] p-6">
            ...
            <div className="mt-5 overflow-hidden rounded-[1.5rem] border border-white/10">
              {sellerAgents.map(({ name, earned, tasks, rating, status }) => (
                <div key={name} className="grid gap-3 border-b border-white/10 bg-black/25 p-4 text-sm last:border-b-0 md:grid-cols-[1.4fr_0.8fr_0.6fr_0.6fr_0.6fr]">
