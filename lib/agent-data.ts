...
export function getAgent(slug: string): AgentListing | undefined {
  return agents.find((agent) => agent.slug === slug)
}

export const taskTimeline = [
  { label: "Checkout session", state: "Paid", detail: "Locus confirmed 0.25 USDC" },
  { label: "Agent execution", state: "Running", detail: "Code Reviewer Agent is producing output" },
  { label: "Delivery", state: "Queued", detail: "Result page polls /api/tasks/[taskId]" },
]
